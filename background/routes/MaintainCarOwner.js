...
router.post('/', function(req, res) {
  ...
  connection.query('SELECT * FROM carplatform.car_information;', function(error, results, fields) {
    ...
    var query =connection.query({
      ...
      // console.log('hiii');
      var date = new Date();
      submitCarOwner(res, JSON.stringify(results), carList, selectedNum, req.body.carlist, JSON.stringify(results[0]))
...
function submitCarOwner(res, msg, carList, selectedNum, carAddress, data) {
